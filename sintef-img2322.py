...
x1_r2 = (res.xyxy[img_nr + 1].iloc[1]['xmin'] + res.xyxy[img_nr + 1].iloc[1]['xmax']) / 2 # Right camera
y1_r2 = (res.xyxy[img_nr + 1].iloc[1]['ymin'] + res.xyxy[img_nr + 1].iloc[1]['ymax']) / 2 # Right camera
...
img_nr = 2
# Round to integers
xmax21 = res.xyxy[img_nr].iloc[0]['xmax']
xmax21 = int(round(xmax21))
ymax21 = res.xyxy[img_nr].iloc[0]['ymax']
ymax21 = int(round(ymax21))
xmin21 = res.xyxy[img_nr].iloc[0]['xmin']
xmin21 = int(round(xmin21))
ymin21 = res.xyxy[img_nr].iloc[0]['ymin']
ymin21 = int(round(ymin21))

# Round to integers
xmax22 = res.xyxy[img_nr].iloc[1]['xmax']
xmax22 = int(round(xmax22))
ymax22 = res.xyxy[img_nr].iloc[1]['ymax']
ymax22 = int(round(ymax22))
xmin22 = res.xyxy[img_nr].iloc[1]['xmin']
xmin22 = int(round(xmin22))
ymin22 = res.xyxy[img_nr].iloc[1]['ymin']
...
x2_r1 = (res.xyxy[img_nr + 1].iloc[1]['xmin'] + res.xyxy[img_nr + 1].iloc[1]['xmax']) / 2 # Right camera
y2_r1 = (res.xyxy[img_nr + 1].iloc[1]['ymin'] + res.xyxy[img_nr + 1].iloc[1]['ymax']) / 2 # Right camera
...
x2_r2 = (res.xyxy[img_nr + 1].iloc[0]['xmin'] + res.xyxy[img_nr + 1].iloc[0]['xmax']) / 2 # Right camera
y2_r2 = (res.xyxy[img_nr + 1].iloc[0]['ymin'] + res.xyxy[img_nr + 1].iloc[0]['ymax']) / 2 # Right camera
...
img_nr = 4
# Round to integers
xmax31 = res.xyxy[img_nr].iloc[0]['xmax']
xmax31 = int(round(xmax31))
ymax31 = res.xyxy[img_nr].iloc[0]['ymax']
ymax31 = int(round(ymax31))
xmin31 = res.xyxy[img_nr].iloc[0]['xmin']
xmin31 = int(round(xmin31))
ymin31 = res.xyxy[img_nr].iloc[0]['ymin']
ymin31 = int(round(ymin31))

# Round to integers
xmax32 = res.xyxy[img_nr].iloc[1]['xmax']
xmax32 = int(round(xmax32))
ymax32 = res.xyxy[img_nr].iloc[1]['ymax']
ymax32 = int(round(ymax32))
xmin32 = res.xyxy[img_nr].iloc[1]['xmin']
xmin32 = int(round(xmin32))
ymin32 = res.xyxy[img_nr].iloc[1]['ymin']
...
# Fish 2
x3_l2 = (res.xyxy[img_nr].iloc[1]['xmin'] + res.xyxy[img_nr].iloc[1]['xmax']) / 2 # Left camera
y3_l2 = (res.xyxy[img_nr].iloc[1]['ymin'] + res.xyxy[img_nr].iloc[1]['ymax']) / 2 # Left camera

x3_r2 = (res.xyxy[img_nr + 1].iloc[1]['xmin'] + res.xyxy[img_nr + 1].iloc[1]['xmax']) / 2 # Right camera
y3_r2 = (res.xyxy[img_nr + 1].iloc[1]['ymin'] + res.xyxy[img_nr + 1].iloc[1]['ymax']) / 2 # Right camera
...
img_nr = 6
# Round to integers
xmax41 = res.xyxy[img_nr].iloc[0]['xmax']
xmax41 = int(round(xmax41))
ymax41 = res.xyxy[img_nr].iloc[0]['ymax']
ymax41 = int(round(ymax41))
xmin41 = res.xyxy[img_nr].iloc[0]['xmin']
xmin41 = int(round(xmin41))
ymin41 = res.xyxy[img_nr].iloc[0]['ymin']
ymin41 = int(round(ymin41))

# Round to integers
xmax42 = res.xyxy[img_nr].iloc[2]['xmax']
xmax42 = int(round(xmax42))
ymax42 = res.xyxy[img_nr].iloc[2]['ymax']
ymax42 = int(round(ymax42))
xmin42 = res.xyxy[img_nr].iloc[2]['xmin']
xmin42 = int(round(xmin42))
ymin42 = res.xyxy[img_nr].iloc[2]['ymin']
...
# Fish 2
x4_l2 = (res.xyxy[img_nr].iloc[2]['xmin'] + res.xyxy[img_nr].iloc[2]['xmax']) / 2 # Left camera
y4_l2 = (res.xyxy[img_nr].iloc[2]['ymin'] + res.xyxy[img_nr].iloc[2]['ymax']) / 2 # Left camera

x4_r2 = (res.xyxy[img_nr + 1].iloc[2]['xmin'] + res.xyxy[img_nr + 1].iloc[2]['xmax']) / 2 # Right camera
y4_r2 = (res.xyxy[img_nr + 1].iloc[2]['ymin'] + res.xyxy[img_nr + 1].iloc[2]['ymax']) / 2 # Right camera
...
img_nr = 8
# Round to integers
xmax51 = res.xyxy[img_nr].iloc[0]['xmax']
xmax51 = int(round(xmax51))
ymax51 = res.xyxy[img_nr].iloc[0]['ymax']
ymax51 = int(round(ymax51))
xmin51 = res.xyxy[img_nr].iloc[0]['xmin']
xmin51 = int(round(xmin51))
ymin51 = res.xyxy[img_nr].iloc[0]['ymin']
ymin51 = int(round(ymin51))

# Round to integers
xmax52 = res.xyxy[img_nr].iloc[2]['xmax']
xmax52 = int(round(xmax52))
ymax52 = res.xyxy[img_nr].iloc[2]['ymax']
ymax52 = int(round(ymax52))
xmin52 = res.xyxy[img_nr].iloc[2]['xmin']
xmin52 = int(round(xmin52))
ymin52 = res.xyxy[img_nr].iloc[2]['ymin']
...
# Fish 2
x5_l2 = (res.xyxy[img_nr].iloc[2]['xmin'] + res.xyxy[img_nr].iloc[2]['xmax']) / 2 # Left camera
y5_l2 = (res.xyxy[img_nr].iloc[2]['ymin'] + res.xyxy[img_nr].iloc[2]['ymax']) / 2 # Left camera

x5_r2 = (res.xyxy[img_nr + 1].iloc[2]['xmin'] + res.xyxy[img_nr + 1].iloc[2]['xmax']) / 2 # Right camera
y5_r2 = (res.xyxy[img_nr + 1].iloc[2]['ymin'] + res.xyxy[img_nr + 1].iloc[2]['ymax']) / 2 # Right camera
