...
img_nr = 10
# Round to integers
xmax6 = res.xyxy[img_nr].iloc[1]['xmax']
xmax6 = int(round(xmax6))
ymax6 = res.xyxy[img_nr].iloc[1]['ymax']
ymax6 = int(round(ymax6))
xmin6 = res.xyxy[img_nr].iloc[1]['xmin']
xmin6 = int(round(xmin6))
ymin6 = res.xyxy[img_nr].iloc[1]['ymin']
...
img_nr = 12
# Round to integers
xmax7 = res.xyxy[img_nr].iloc[1]['xmax']
xmax7 = int(round(xmax7))
ymax7 = res.xyxy[img_nr].iloc[1]['ymax']
ymax7 = int(round(ymax7))
xmin7 = res.xyxy[img_nr].iloc[1]['xmin']
xmin7 = int(round(xmin7))
ymin7 = res.xyxy[img_nr].iloc[1]['ymin']
